...
% xrData=flipud(xrData);
% FrData=flipud(FrData);
% imgIndDataRtn=flipud(imgIndDataRtn);
StrRetnData=reshapeData([teData;xeData;FeData;imgIndDataExt],fliplr([trData;xrData;FrData;imgIndDataRtn]));
